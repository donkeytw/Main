<?php
    ...
    function sendToDb(): string {
        ...
        //Insert statement
        $sql = "INSERT INTO Experience VALUES ('$site_attended', '$clinical_site', '$clinical_staff', '$learning_obj', '$preceptor', '$recommend_site', '$site_comments', '$instructor_comments', '$date_submitted');";
