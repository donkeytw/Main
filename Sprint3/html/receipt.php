...
function valid() : string {
    ...
    return <<<HTML
                ...
                <p class="{$color} col-4 mx-auto p-1" id="receipt-code">CODE: {$code}</p>
HTML;
}
...
<!--                <a class="btn btn-secondary" href="home.html"">Home</a>-->
                <a class="btn" id="receipt-btn" href="experience.html">Experience Form</a> 
HTML;
